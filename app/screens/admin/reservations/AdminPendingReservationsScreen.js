...
const AdminActiveReservationsScreen = props => {
    ...
    const pendingReservations = useSelector(state => state.adminReservations.pendingReservations);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.noContent}>
                    <View style={styles.noContentCard}>
                        <Text style={styles.noContentText}>{t('reservation_history.no_pending_reservation')}</Text>
                    </View>
                </View>
            </View>
        );
