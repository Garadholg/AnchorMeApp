...
const AdminActiveReservationsScreen = props => {
    ...
    const completedReservations = useSelector(state => state.adminReservations.completedReservations);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.noContent}>
                    <View style={styles.noContentCard}>
                        <Text style={styles.noContentText}>{t('reservation_history.no_completed_reservation')}</Text>
                    </View>
                </View>
            </View>
        );
