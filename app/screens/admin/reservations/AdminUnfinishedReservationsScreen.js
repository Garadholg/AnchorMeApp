...
const AdminActiveReservationsScreen = props => {
    ...
    const unfinishedReservations = useSelector(state => state.adminReservations.unfinishedReservations);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.noContent}>
                    <View style={styles.noContentCard}>
                        <Text style={styles.noContentText}>{t('reservation_history.no_unfinished_reservation')}</Text>
                    </View>
                </View>
            </View>
        );
