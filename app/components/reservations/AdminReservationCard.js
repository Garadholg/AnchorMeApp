...
const ReservationCard = props => {
    ...
    return (
        <TouchableOpacity 
            style={styles.card} 
            activeOpacity={0.8}
            onPress={() => props.onPress(props.reservation.ReservationID, props.reservation.Status)}
            >

            <Text style={styles.name}>{props.reservation.UserFullName} ({props.reservation.UserUsername})</Text>
